...
public class RegistroAdmin extends JFrame {
    ...
    JTextField txtNombre, txtApellidos, txtNumTrabajador, txtUsuario;
    JPasswordField txtContrasena;
    JButton btnRegistrar, btnCancelar;

    public RegistroAdmin(Controlador controlador) {
        this.controlador = controlador;

        setTitle("Registro Admin / Docente");
        setSize(600, 500);
        ...
        panelFormulario.add(new JLabel("Número de trabajador:"));
        txtNumTrabajador = new JTextField();
        panelFormulario.add(txtNumTrabajador);
    ...
    private void registrar() {
        ...
        if (nombre.isEmpty() || apellidos.isEmpty() || numTrabajador.isEmpty() || usuario.isEmpty() || contrasena.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Todos los campos son obligatorios");
        } else {
            JOptionPane.showMessageDialog(this, "Admin / Docente registrado exitosamente (prototipo)");
            dispose();
        }
    }
}